...
final profilControllerProvider =
    NotifierProvider<ProfilController, ProfilState>(ProfilController.new);
...
class ProfilController extends Notifier<ProfilState> {
  ProfilRepository get _repository => ref.read(profilRepositoryProvider);
...
// Pour le thème, vu qu'il n'y a pas encore de dossier Provider
