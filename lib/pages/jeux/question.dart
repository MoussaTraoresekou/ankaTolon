...
class _QuizPlayScreenState extends State<QuizPlayScreen> {
  ...
  void _showResultDialog() {
    ...
    if (successRate == 1.0) {
      title = "👑 Parfait ! 👑";
      message =
          "Incroyable ! Tu as trouvé toutes les réponses ! Un vrai champion !";
      emoji = "🏆";
    } else if (successRate >= 0.5) {
      title = "🎉 Super ! 🎉";
      message =
          "Tu as trouvé $_correctAnswersCount sur $totalQuestions bonnes réponses. Bien joué !";
      emoji = "⭐️";
    } else if (_correctAnswersCount > 0) {
      title = "👍 Pas mal ! 👍";
      message =
          "Tu as eu $_correctAnswersCount de juste. Continue d'apprendre pour faire mieux !";
      emoji = "💪";
    } else {
      title = "🙃 Oups... 🙃";
      message =
          "Aucune bonne réponse cette fois-ci, mais ne décourage pas ! Réessaie encore !";
      emoji = "📚";
    }
          ...
          child: Column(
            ...
            children: [
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    Color borderColor = isSelected
                        ? const Color(0xFF63B47E)
                        : const Color(0xFFF1F5F9);
                    Color letterBgColor = isSelected
                        ? const Color(0xFF63B47E)
                        : const Color(0xFFF8FAFC);
                    Color letterTextColor = isSelected
                        ? Colors.white
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Image.asset(
                              currentQuestion.optionEmojis[index],
                              height: 70,
                              width: 80,
                            ),
                          ],
              ...
              ElevatedButton(
                ...
                child: Text(
                  _currentIndex == widget.theme.questions.length - 1
                      ? "Terminer"
                      : "Suivant",
                  style: const TextStyle(
                    fontSize: 16,
